  ...
  <body>
    <!-- sessão da logo -->
      ...
      <form method="POST" action="#">
        <label class="editar-add">Fazer um Pedido</label>
        <label class="nome-do-pedido">Nome do pedido:</label>
        <input name="Nome" type="text" class="txtbNomeP">
        <label class="txtDesc"> Fale mais sobre o seu projeto: </label>
        <textarea name="Desc" class="txtbDescricao"></textarea>
        <button name="add" class="btnConcluido">Concluido</button>
      </form>
    </body>
</html>
