...
<html lang="pt-br">
  ...
  <body>
      ...
      <form name="Login" method="POST" action="auth.php" >
        ...
        <label class="senha">Digite sua Senha:</label>
        <input name="senha" class="txtbSenha" type="password">
        <div class="btnCima">
          <input name="login" type="submit" value="Entrar na sua Conta" class="buttonCimaLogin">
        </div>
        <div class="linEsq"></div>
        <div class="ou">ou</div>
        <div class="linDir"></div>
        <a href="Cadastro.php" class="btnBaixo">
          <input type="button" value="Crie sua conta" class="buttonBaixoLogin">
        </a>
